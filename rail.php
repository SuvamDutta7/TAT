...
<html>
<head>
<title>Railway Department</title>
       ...
       <div id="fwslider">
         <div class="slider_container">
            <div class="slide"> 
                ...
                <!-- Slide image -->
               <img src="images/rail1.jpg" class="img-responsive" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
				...
				<table border="1px" style="float:right; border-color: #000000">
				<th><label id="tc" style="float:right; font-size: 18px;"><a href="flight_tc.php">Ticket Cancellation</a></label></th>
				<th><label id="bs" style="float:right; font-size: 18px"><a href="#">Booking Status </a></label></th>
                  </table>  
...
<!--<a href="#">Ticket cancellation</a> </h2>-->
						...
						Select Source:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							...
							<!--<select id="cmbMake" name="Make"     onchange="document.getElementById('selected_text').value=this.options[this.selectedIndex].text">
									<option value="0" disabled="disabled" selected="selected" id="place">Enter Source</option>
							...
							<select id="cmbMake" name="Make1"     onchange="document.getElementById('selected_text1').value=this.options[this.selectedIndex].text">
									<option value="0" disabled="disabled" selected="selected" id="place">Enter Destination</option>
									<option value="1">Delhi</option>
									<option value="2">Bangalore</option>
						...
						<div>
							...
							<select id="cmbMake" name="class" onChange="document.getElementById('selected_text4').value=this.options[this.selectedIndex].text">
										<option value="0" disabled="disabled" selected="selected" id="place">Class</option>
